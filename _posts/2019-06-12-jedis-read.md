...
![](/assets/images/posts/jedis-read/packages.png)
...
![](/assets/images/posts/jedis-read/jedis-get.png)
...
![](/assets/images/posts/jedis-read/sendCommand.png)

## JedisCluster

使用 Set<HostAndPort> 进行初始化。

![](/assets/images/posts/jedis-read/jedisCluster-get.png)

类顺序：JedisCluster -> BinaryJedisCluster -> JedisClusterCommand -> Jedis ->  BinaryClient -> Connection -> Protocol

![](/assets/images/posts/jedis-read/runWithRetries.png)
