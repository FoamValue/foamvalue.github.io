...
![](/assets/images/posts/seckill/explorer.png)
...
![](/assets/images/posts/seckill/thread-20.png)
...
![](/assets/images/posts/seckill/secKillImpl.png)
...
![](/assets/images/posts/seckill/run-20.png)

## Proxy.newProxyInstance

线程中，采用动态代理实现商品扣减的动作。

![](/assets/images/posts/seckill/secKillTest.png)
...
![](/assets/images/posts/seckill/cacheLockInterceptor-invoke.png)

通过 getLockedObject 方法获取锁定对象。

![](/assets/images/posts/seckill/cacheLockInterceptor.png)

## RedisLock

一个循环锁定，成功即结束，失败短暂 sleep 后重试。

![](/assets/images/posts/seckill/redisLock.png)
